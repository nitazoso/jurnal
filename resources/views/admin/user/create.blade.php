        ...
        <div class="form-body">
            <form id="addUserForm" action="{{ route('admin.user.store') }}" method="POST" class="form-grid" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="password" name="password" class="form-input" placeholder="Minimal 6 karakter" autocomplete="new-password" required>
                    <span id="passwordError" class="field-error">Password minimal 6 karakter.</span>
                    <span class="form-helper">Password digunakan untuk login dan minimal 6 karakter.</span>
                </div>
