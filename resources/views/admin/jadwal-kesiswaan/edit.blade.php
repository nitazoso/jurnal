...
@section('page-subtitle', 'Perbarui data petugas kesiswaan yang bertugas melakukan ACC dispen')
...
<div class="form-page">
    ...
    <div class="form-header">
        <div>
            <h2 class="form-title">Edit Jadwal Petugas</h2>
            <p class="form-subtitle">
                Perbarui tanggal atau petugas kesiswaan yang bertugas melakukan ACC dispen.
            </p>
        </div>
    </div>
    ...
    <div class="form-card">
        ...
        <div class="form-card-header">
            ...
            <div>
                ...
                <p>Perbarui data petugas kesiswaan yang akan bertugas.</p>
            </div>
        </div>
