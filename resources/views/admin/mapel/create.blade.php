...
@section('title', 'Tambah Mata Pelajaran - Jurnify')
@section('page-title', 'Tambah Mata Pelajaran')
@section('page-subtitle', 'Tambahkan data mata pelajaran baru ke dalam sistem')
    ...
    <div class="form-container">
        ...
        <div class="header-card">
            <div class="header-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    <path d="M12 8v6M9 11h6" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
            </div>
            <div class="header-info">
                <h1 class="header-title">Tambah Mata Pelajaran</h1>
                <p class="header-subtitle">Isi formulir di bawah ini untuk menambahkan mata pelajaran baru</p>
            </div>
        </div>
        ...
        <div class="form-card">
            <div class="card-header-inner">
                <h2 class="card-title">Informasi Mata Pelajaran</h2>
                <p class="card-subtitle">Pastikan nama mata pelajaran belum pernah terdaftar sebelumnya.</p>
            </div>
                ...
                <div class="card-body-inner">
                    <div class="form-group">
                        ...
                        <span class="form-hint">
                            ...
                            Gunakan nama resmi yang sesuai dengan kurikulum sekolah.
                        </span>
                    </div>
                </div>
...
<style>
    ...
    .mapel-create-page {
        width: 100%;
        padding: 24px 32px 48px; /* Safe padding di sekeliling container */
        animation: mapelFadeUp 0.45s cubic-bezier(.16, 1, .3, 1) both;
    }

    .form-container {
        width: 100%;
        max-width: 1000px; /* Dilebarkan dari 680px menjadi 1000px */
        margin: 0 auto;
        display: flex;
