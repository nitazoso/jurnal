...
@section('title', 'Tambah Jam Pelajaran - Jurnify')
...
<div class="p-8">
    ...
    <div class="mb-6">
        ...
        <p class="text-sm text-slate-500 mt-1">
            Tambahkan waktu jam pelajaran ke sistem.
        </p>
    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <select
                        ...
                        required
                    >
                        <option value="">Pilih Kelompok Hari</option>
                        <option value="Senin-Kamis" {{ old('klp_hari') == 'Senin-Kamis' ? 'selected' : '' }}>
                            Senin-Kamis
                        </option>
                        <option value="Jumat" {{ old('klp_hari') == 'Jumat' ? 'selected' : '' }}>
                            Jumat
                        </option>
                    </select>
                ...
                <div>
                    ...
                    >
                        ...
                        <option value="Pelajaran" {{ old('jenis') == 'Pelajaran' ? 'selected' : '' }}>
                            Pelajaran
                        </option>
                        <option value="Istirahat" {{ old('jenis') == 'Istirahat' ? 'selected' : '' }}>
                            Istirahat
                        </option>
                    </select>
