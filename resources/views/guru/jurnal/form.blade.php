        ...
        <form action="{{ route('guru.jurnal.store') }}" method="POST" id="journalForm">
                ...
                <div class="section-header">
                    <div class="section-icon">
                        <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3.75 9h16.5M5.25 4.5h13.5A1.5 1.5 0 0 1 20.25 6v13.5a1.5 1.5 0 0 1-1.5 1.5H5.25a1.5 1.5 0 0 1-1.5-1.5V6a1.5 1.5 0 0 1 1.5-1.5Z"/>
                        </svg>
                    </div>
                    <div>
                ...
                <div class="schedule-grid">
                    <div class="field-group">
                        ...
                        <div class="readonly-field">
                            <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 5.25A2.25 2.25 0 0 1 6.75 3h10.5A2.25 2.25 0 0 1 19.5 5.25v13.5A2.25 2.25 0 0 1 17.25 21H6.75a2.25 2.25 0 0 1-2.25-2.25V5.25Z"/>
                            </svg>
                            {{ $jadwal->tahun_ajaran ?? '-' }}
                        </div>
                    </div>
                    <div class="field-group">
                        ...
                        <input type="date" name="tanggal" value="{{ old('tanggal', date('Y-m-d')) }}" class="field-input" required>
                    </div>
                    <div class="field-group">
                        <label class="field-label">Kelas</label>
                        <div class="readonly-field">
                            <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M17 20h5v-2a4 4 0 0 0-4-4h-1M9 20H4v-2a4 4 0 0 1 4-4h1m4-4a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm6 1a3 3 0 1 0 0-6"/>
                            </svg>
            ...
            <section class="form-card mobile-hide-section">
                <div class="teacher-status">
                    ...
                    <div class="status-buttons">
                        <button type="button" class="status-btn active" data-teacher-status="Hadir" onclick="setTeacherStatus(this, 'Hadir')">
                            Hadir
                        </button>
                        <button type="button" class="status-btn" data-teacher-status="Izin" onclick="setTeacherStatus(this, 'Izin')">
                            Izin
                        </button>
            ...
            <section class="form-card">
                <div class="student-desktop-header">
                    ...
                    <div class="student-search">
                        <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" d="m21 21-4.35-4.35m1.35-5.4a6.75 6.75 0 1 1-13.5 0Z"/>
                        </svg>
                        <input type="text" id="studentSearchDesktop" class="field-input" placeholder="Cari nama siswa..." oninput="searchStudents(this.value)">
                    </div>
                </div>
                ...
                <div class="summary-grid">
                    ...
                    <div class="summary-card summary-sakit">
                        <div class="summary-top">
                            ...
                            <svg class="summary-icon" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v4m0 4h.01M10.3 3.6 2.8 17a2 2 0 0 0 1.75 3h14.9a2 2 0 0 0 1.75-3L13.7 3.6a2 2 0 0 0-3.4 0Z"/>
                            </svg>
                        </div>
                ...
                <div class="student-mobile-search">
                    ...
                    <input type="text" id="studentSearchMobile" class="field-input" placeholder="Cari nama siswa" oninput="searchStudents(this.value)">
                </div>
                {{-- STUDENT TABLE --}}
                            ...
                            <tbody>
                                @forelse($siswa as $item)
                                    ...
                                    >
                                        ...
                                        <td class="student-name" data-initial="{{ strtoupper(substr($item->nama_siswa, 0, 1)) }}{{ strtoupper(substr(explode(' ', trim($item->nama_siswa))[1] ?? '', 0, 1)) }}"
            ...
            <section class="form-card mobile-hide-section">
                <div class="section-header">
                    <div class="section-icon">
                        <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M8 6h8M8 10h8M8 14h5M5 3h10l4 4v14H5V3Z"/>
                        </svg>
                    </div>
                    <div>
            ...
            <div class="action-buttons">
                ...
                <button type="submit" class="btn btn-primary">
                    <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75 10 18l9.5-6"/>
                    </svg>
                    Simpan Jurnal
                </button>
            </div>
