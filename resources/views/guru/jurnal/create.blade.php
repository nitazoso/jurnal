                    ...
                    <tbody>
                        @forelse($jadwals as $jadwal)
                            <tr>
                                ...
                                {{-- AKSI --}}
                                <td>
                                    <a href="{{ route('guru.jurnal.form', $jadwal->id_jadwal) }}" class="journal-action">
                                        <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            ...
                            <tr class="empty-row">
                                <td colspan="6">
                                    <div class="empty-state">
                                        ...
                                        <p class="empty-title">Belum ada jadwal mengajar</p>
                                        <p class="empty-text">Jadwal mengajar Anda belum tersedia.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
